...
async def main():
    ...
    async def message_handler(msg):
        ...
        print("C Received a message on '{subject} {reply}': {data}".format(
    ...
    try:
        async for msg in sub.messages:
            print(f"A Received a message on '{msg.subject} {msg.reply}': {msg.data.decode()}")
            await sub.unsubscribe()
    except Exception as e:
        pass

    async def help_request(msg):
        print(f"B Received a message on '{msg.subject} {msg.reply}': {msg.data.decode()}")
