...
def test_action_control():
    ...
    assert str(control_action) == "{'type': 'Control', 'target_id': '69bb52ce-c59c-11ec-abff-00155d8c61bb', 'task_id': '4c963e70-c59c-11ec-bb5f-00155d8c61bb', 'body': 'This is the body'}"
...
def test_action_data():
    ...
    assert str(data_action) == "{'type': 'Data', 'source': '/home/source/file1.txt', 'destination': 'home/dest/file1.txt'}"
...
def test_action_compute():
    ...
    com = Factory(payload)
    assert str(com) == "{'type': 'Compute', 'workflow_id': '8353332c-c59d-11ec-9b3a-00155d8c61bb', 'parameters': {'compute': 'this is a workflow param'}}"
